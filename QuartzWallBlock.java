package com.novaventure.submersible_aquatic_research_apparatuses.registry.registry.Blocks.Building_Materials;
...
public class QuartzWallBlock extends Block implements Waterloggable {
    ...
    public QuartzWallBlock(Settings settings) {
        super(settings);
    ...
    private boolean method_27092(BlockState blockState, BlockState blockState2, VoxelShape voxelShape) {
        boolean bl = blockState2.getBlock() instanceof net.minecraft.block.WallBlock && (Boolean)blockState2.get(UP);
        if (bl) {
            return true;
        } else {
